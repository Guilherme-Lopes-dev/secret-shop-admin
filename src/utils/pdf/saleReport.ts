...
export function generateSaleReportPdf(sale: Sale) {
  const doc = new jsPDF()
  let y = 15

  doc.setFontSize(16)
  doc.setFont('helvetica', 'bold')
  doc.text(`Relatorio de Venda #${sale.order_number || '-'}`, 14, y)
  y += 7
  doc.setFontSize(10)
  doc.setFont('helvetica', 'normal')
  doc.setTextColor(120)
  doc.text(`Gerado em ${dayjs().format('DD/MM/YYYY HH:mm:ss')}`, 14, y)
  doc.setTextColor(0)
  y += 8
